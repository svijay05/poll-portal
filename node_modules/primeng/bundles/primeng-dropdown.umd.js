(function (global, factory) {
    ...
    var Dropdown = /** @class */ (function () {
        ...
        Dropdown.prototype.onMouseclick = function (event) {
            ...
            this.selfClick = true;
            this.clearClick = dom.DomHandler.hasClass(event.target, 'ui-dropdown-clear-icon');
                ...
                if (this.group) {
                    ...
                    try {
                        for (var _b = __values(this.options), _c = _b.next(); !_c.done; _c = _b.next()) {
                            ...
                            var filteredSubOptions = utils.FilterUtils.filter(optgroup.items, searchFields, this.filterValue, this.filterMatchMode);
                    ...
                    this.optionsToDisplay = utils.FilterUtils.filter(this.options, searchFields, this.filterValue, this.filterMatchMode);
                }
                this.optionsChanged = true;
            }
        };
        ...
        __decorate([
            core.ViewChild('editableInput', { static: false })
