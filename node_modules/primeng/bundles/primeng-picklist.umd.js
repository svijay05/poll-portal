    ...
    var PickList = /** @class */ (function () {
        ...
        PickList.prototype.onFilter = function (event, data, listType) {
            ...
            if (listType === this.SOURCE_LIST) {
                ...
                this.visibleOptionsSource = utils.FilterUtils.filter(data, searchFields, this.filterValueSource, this.filterMatchMode);
                this.onSourceFilter.emit({ query: this.filterValueSource, value: this.visibleOptionsSource });
            }
            else if (listType === this.TARGET_LIST) {
                this.filterValueTarget = query;
                this.visibleOptionsTarget = utils.FilterUtils.filter(data, searchFields, this.filterValueTarget, this.filterMatchMode);
        ...
        __decorate([
            core.ViewChild('sourcelist', { static: true })
        ], PickList.prototype, "listViewSourceChild", void 0);
        __decorate([
            core.ViewChild('targetlist', { static: true })
        ], PickList.prototype, "listViewTargetChild", void 0);
        __decorate([
            core.ViewChild('sourceFilter', { static: false })
        ], PickList.prototype, "sourceFilterViewChild", void 0);
        __decorate([
            core.ViewChild('targetFilter', { static: false })
