(function (global, factory) {
    ...
    var Listbox = /** @class */ (function () {
        ...
        Listbox.prototype.isItemVisible = function (option) {
            if (this.filterValue) {
                var visible = void 0;
                var filterText = utils.ObjectUtils.removeAccents(this.filterValue).toLowerCase();
                if (this.filterMode) {
                    visible = utils.FilterUtils[this.filterMode](option.label, this.filterValue);
                }
                else {
                    visible = true;
                }
        ...
        __decorate([
            core.ViewChild('headerchkbox', { static: true })
